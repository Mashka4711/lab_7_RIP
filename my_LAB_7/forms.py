...
class RegistrationForm(forms.Form):
    ...
    password_2 = forms.CharField(widget=forms.PasswordInput(attrs={'class': 'form-control', 'id': 'password_2'}),
                                 min_length=8, label='Повторите пароль:')

    def rem_password_2(self):
        if self.cleaned_data.get('password') != self.cleaned_data.get('password_2'):
    ...
    def rem_username(self):
        ...
        try:
            ...
            raise forms.ValidationError('This login is not available')
